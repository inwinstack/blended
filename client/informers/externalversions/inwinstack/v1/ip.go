	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InwinstackV1().IPs(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InwinstackV1().IPs(namespace).Watch(options)
			},
		},
		&inwinstackv1.IP{},
		resyncPeriod,
...
func (f *iPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&inwinstackv1.IP{}, f.defaultInformer)
}
