...
var servicesKind = schema.GroupVersionKind{Group: "inwinstack.com", Version: "v1", Kind: "Service"}
...
func (c *FakeServices) Get(name string, options v1.GetOptions) (result *inwinstackv1.Service, err error) {
	...
	return obj.(*inwinstackv1.Service), err
}
...
func (c *FakeServices) List(opts v1.ListOptions) (result *inwinstackv1.ServiceList, err error) {
	...
	list := &inwinstackv1.ServiceList{ListMeta: obj.(*inwinstackv1.ServiceList).ListMeta}
	for _, item := range obj.(*inwinstackv1.ServiceList).Items {
...
func (c *FakeServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *inwinstackv1.Service, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(servicesResource, name, pt, data, subresources...), &inwinstackv1.Service{})
	if obj == nil {
		return nil, err
	}
	return obj.(*inwinstackv1.Service), err
